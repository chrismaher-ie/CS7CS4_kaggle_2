...
# Split the test and training data
X_train, X_test, y_train, y_test_2 = train_test_split(X_2, y_2, test_size=0.1, random_state=42)

#Setup BayesianRidge regressor
regr_2 =  CatBoostRegressor()

# Train the model using the training sets
regr_2.fit(X_train, np.sqrt(y_train))
...
# export data
pd.DataFrame(y_results).to_csv("Predictions.csv")
