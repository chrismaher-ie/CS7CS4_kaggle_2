...
Y = income_train.loc[:, 'Total Yearly Income [EUR]']
...
## predictions
income_test['Income'] =  model.predict(income_test.loc[:, income_test.columns != 'Total Yearly Income [EUR]'])
Results = income_test[[ 'Income']].copy()
Results.to_csv(r'C:\Users\Me\Documents\College\Maths 4th Year\Machine Learning\Group competition\Results1.csv')
